...
public class Login {
    ...
    @And("Keeping {string} as (Valid|InValid)")
    public void keepingCase(String caseType) {
    	String res=(caseType.equals("Valid"))?"The credential is valid":"The credential is invalid";
    ...
    public void messageDisplayedLoginSuccessfully(String message) {
    ...
    public void userAskedToGoBackToLoginPage() {
    	WebElement submit=driver.findElement(By.xpath("//*[@id=\"content\"]/div/div[2]/div/form/input"));  
        submit.click();
        WebElement errorMessage = driver.findElement(By.xpath("//*[@id=\"account-login\"]/div[1]/text()"));
    ...
    public void provideCorrectCredentials() {
        // Optionally, provide correct credentials after the login failure scenario
    }
